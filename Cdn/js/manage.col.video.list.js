  ...
  $.getJSON('../Cdn/js/data/videos.json', function (videoData) {
    ...
    slicedData.forEach(video => {
      videoListHtml += `
            <div class="col-lg-4 col-md-6 col-sm-12 mb-2">
                <div class="card" data-ebook-id="${video.video_id}" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" style="height:100%; cursor: pointer;">
                        <!-- Photo -->
    ...
    $('.card').click(function () {
      ...
      $.getJSON('../Cdn/js/data/videos.json', function (data) {
        ...
        $(".watch-video").attr("href", `manage.col.view.video.html?video_id=` + videoId)
      });
    });
  });
}
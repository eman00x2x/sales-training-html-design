...
function getAccountsData() {
    ...
    $.when(
        ...
        for (let i = 0; i < slicedData.length; i++) {
            ...
            html += "<a class='btn border-primary bg-body' href='organization.user.view.html?id=" + data.profile_id + "'> <i class='bi bi-eye'></i> View</a>";
            html += "<a class='btn border-danger bg-body' href='organization.user.delete.html?id=" + data.profile_id + "'> <i class='bi bi-trash'></i> Delete</a>";
            html += "</div>";
            html += "</td>";
            html += "</tr>";

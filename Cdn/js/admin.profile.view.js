$(document).ready(function () {
    ...
    $('#tab-top-1').load('admin.profile.tabs.profile.html');
    $('#tab-top-2').load('admin.profile.tabs.skills.html');
    $('#tab-top-3').load('admin.profile.tabs.password.html');
    $('#tab-top-4').load('admin.profile.tabs.email.html');
});
